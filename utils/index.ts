...
const getData = async (param: any) => {
  ...
  //     nytdsection: "world",
  //     adx_keywords:
  //       "Archaeology and Anthropology;Palaces and Castles;Royal Families;Historic Buildings and Sites;Organizations, Societies and Clubs;Henry VIII, King of England;Collyweston (England);England;Great Britain",
  //     column: null,
  ...
  //     ],
  //     org_facet: [],
  //     per_facet: ["Henry VIII, King of England"],
  //     geo_facet: ["Collyweston (England)", "England", "Great Britain"],
  //     media: [
  //       {
  //         type: "image",
  //         subtype: "photo",
  ...
  //     nytdsection: "u.s.",
  //     adx_keywords:
  //       "Abortion;Presidential Election of 2016;Roe v Wade (Supreme Court Decision);Dobbs v Jackson Women's Health Organization (Supreme Court Decision);Presidential Election of 2024;United States Politics and Government;Clinton, Hillary Rodham;Trump, Donald J;Democratic Party;Supreme Court (US)",
  //     column: null,
  ...
  //     ],
  //     org_facet: ["Democratic Party", "Supreme Court (US)"],
  //     per_facet: ["Clinton, Hillary Rodham", "Trump, Donald J"],
  //     geo_facet: [],
  //     media: [
  //       {
  //         type: "image",
  //         subtype: "photo",
  //         caption:
  //           "The interview represented Mrs. Clinton’s most detailed comments on abortion rights since the Supreme Court decision overturning Roe v. Wade.",
  ...
  //     nytdsection: "opinion",
  //     adx_keywords:
  //       "Women and Girls;Women's Rights;Sex;Middle Age (Demographic)",
  //     column: null,
  ...
  //     nytdsection: "travel",
  //     adx_keywords:
  //       "Travel and Vacations;Summer (Season);Hotels and Travel Lodgings;Islands;White Elephant Hotel;Nantucket (Mass)",
  //     column: null,
  ...
  //       "Islands",
  //     ],
  //     org_facet: ["White Elephant Hotel"],
  //     per_facet: [],
  //     geo_facet: ["Nantucket (Mass)"],
  //     media: [
  //       {
  //         type: "image",
  //         subtype: "photo",
  //         caption:
  //           "When the White Elephant opened on Nantucket 100 years ago, many doubted the island would draw visitors. Last year, the hotel reopened after an extensive renovation. ",
  ...
  //     nytdsection: "arts",
  //     adx_keywords:
  //       "Classical Music;United States Defense and Military Forces;Content Type: Personal Profile;Careers and Professions;Brooks, Ada;United States Military Academy Band;United States Military Academy;United States Army;West Point (NY)",
  //     column: null,
  ...
  //       "United States Army",
  //     ],
  //     per_facet: ["Brooks, Ada"],
  //     geo_facet: ["West Point (NY)"],
  //     media: [
  //       {
  //         type: "image",
  //         subtype: "photo",
  ...
  //     nytdsection: "science",
  //     adx_keywords:
  //       "Birds;Birdwatching;Animal Cognition;Animal Behavior;internal-truncator",
  //     column: null,
  ...
  //     adx_keywords:
  //       "Electric Bicycles, Motorcycles and Scooters;Delivery Services;Traffic Accidents and Safety;Mobile Applications;Joshi, Meera;New York City",
  //     column: null,
  ...
  //     nytdsection: "opinion",
  //     adx_keywords:
  //       "Museums;Arts and Antiquities Looting;Parthenon (Greece);Nashville (Tenn);Mexico",
  //     column: null,
  ...
  //     org_facet: [],
  //     per_facet: [],
  //     geo_facet: ["Nashville (Tenn)", "Mexico"],
  //     media: [
  //       {
  //         type: "image",
  //         subtype: "photo",
  ...
  //     nytdsection: "style",
  //     adx_keywords:
  //       "internal-truncator;Restaurants;Beef;Relocation of Business;Italian Food (Cuisine);Pietro's (Manhattan, NY, Restaurant);Midtown Area (Manhattan, NY)",
  //     column: null,
  ...
  //     ],
  //     org_facet: ["Pietro's (Manhattan, NY, Restaurant)"],
  //     per_facet: [],
  //     geo_facet: ["Midtown Area (Manhattan, NY)"],
  //     media: [
  //       {
  //         type: "image",
  //         subtype: "photo",
  ...
  //     nytdsection: "u.s.",
  //     adx_keywords:
  //       "Memorial Day;Veterans;Monuments and Memorials (Structures);Veterans Day (US);Awards, Decorations and Honors;Holidays and Special Occasions;United States",
  //     column: null,
  ...
  //         subtype: "photo",
  //         caption:
  //           "Krista Meinert sitting beside her son’s headstone at Arlington National Cemetery in Virginia last May.",
  ...
  //     nytdsection: "world",
  //     adx_keywords:
  //       "Content Type: Personal Profile;Israel-Gaza War (2023- );Terrorism;Kidnapping and Hostages;internal-truncator;Bitton, Yuval;Sinwar, Yehya;Hamas;Israel;Gaza Strip",
  //     column: null,
  ...
  //     ],
  //     org_facet: ["Hamas"],
  //     per_facet: ["Bitton, Yuval", "Sinwar, Yehya"],
  ...
  //     nytdsection: "u.s.",
  //     adx_keywords:
  //       "Service Dogs and Other Animals;Decisions and Verdicts;Blindness;United States Politics and Government;Courts and the Judiciary;Tatel, David S;Supreme Court (US)",
  //     column: null,
  ...
  //         subtype: "photo",
  //         caption:
  //           "Judge David S. Tatel and his service dog, Vixen, met in 2019, transforming Judge Tatel’s life.",
  ...
  //     nytdsection: "style",
  //     adx_keywords:
  //       "Social Media;Skin;Agriculture and Farming;Generation Z;Cosmetics and Toiletries;internal-truncator;Bag Balm;TikTok (ByteDance)",
  //     column: null,
  ...
  //       "internal-truncator",
  //     ],
  //     org_facet: ["Bag Balm", "TikTok (ByteDance)"],
  //     per_facet: [],
  //     geo_facet: [],
  //     media: [
  //       {
  ...
  //         subtype: "photo",
  //         caption:
  //           "Freshly filled containers of Bag Balm cooling on a conveyor belt at a plant in Lyndonville, Vt.",
  ...
  //     nytdsection: "science",
  //     adx_keywords:
  //       "Sun;Space and Astronomy;Architecture;Content Type: Service;Manhattan (NYC);New York City",
  //     column: null,
  ...
  //     org_facet: [],
  //     per_facet: [],
  //     geo_facet: ["Manhattan (NYC)", "New York City"],
  //     media: [
  //       {
  //         type: "image",
  //         subtype: "photo",
  //         caption:
  //           "Manhattanhenge observed on 42nd street in Manhattan last May.",
  ...
  //     adx_keywords:
  //       "Basketball;Books and Literature;Sports Injuries;Anderson, Sam;Walton, Bill;Grateful Dead;National Basketball Assn",
  //     column: null,
  //     byline: "By Sam Anderson",
  //     type: "Article",
  //     title: "Bill Walton’s Long, Strange Tale of N.B.A. Survival",
  //     abstract:
  //       "A basketball legend looks back with surprising gratitude on a life plagued by physical agony.",
  //     des_facet: ["Basketball", "Books and Literature", "Sports Injuries"],
  //     org_facet: ["Grateful Dead", "National Basketball Assn"],
  //     per_facet: ["Anderson, Sam", "Walton, Bill"],
  //     geo_facet: [],
  //     media: [
  //       {
  //         type: "image",
  ...
  //     nytdsection: "opinion",
  //     adx_keywords:
  //       "Israel-Gaza War (2023- );Books and Literature;Jews and Judaism;Zionism;Writing and Writers;Book Trade and Publishing;Anti-Semitism;PEN American Center;Jewish Book Council;Gaza Strip;Israel",
  //     column: null,
  ...
  //       "Anti-Semitism",
  //     ],
  //     org_facet: ["PEN American Center", "Jewish Book Council"],
  //     per_facet: [],
  ...
  //     org_facet: [],
  //     per_facet: [],
  //     geo_facet: ["China", "Europe", "United States", "Germany"],
  //     media: [
  //       {
  //         type: "image",
  //         subtype: "photo",
  ...
  //     nytdsection: "u.s.",
  //     adx_keywords:
  //       "vis-photo;Elections, Senate;Domestic Migration;Voting and Voters;United States Politics and Government;Economic Conditions and Trends;Tester, Jon;Sheehy, Tim (1985- );Democratic Party;Republican Party;Senate;Montana;Bozeman (Mont)",
  //     column: null,
  ...
  //       "Economic Conditions and Trends",
  //     ],
  //     org_facet: ["Democratic Party", "Republican Party", "Senate"],
  //     per_facet: ["Tester, Jon", "Sheehy, Tim (1985- )"],
  //     geo_facet: ["Montana", "Bozeman (Mont)"],
  //     media: [
  //       {
  //         type: "image",
  //         subtype: "photo",
  ...
  //     nytdsection: "new york",
  //     adx_keywords:
  //       "Hotels and Travel Lodgings;Prices (Fares, Fees and Rates);Immigration Shelters;Shortages;Government Contracts and Procurement;Adams, Eric L;Hotel Association of New York;Airbnb;New York City",
  //     column: null,
  ...
  //     ],
  //     org_facet: ["Hotel Association of New York", "Airbnb"],
  //     per_facet: ["Adams, Eric L"],
  //     geo_facet: ["New York City"],
  //     media: [
  //       {
  //         type: "image",
  //         subtype: "photo",
  //         caption:
  //           "Many of the hotels now operating as shelters, like The Row in the Times Square area, are congregated in places like Midtown Manhattan and near Kennedy Airport.",
  ...
  if (param.search) {
    return arr.filter((article: any) => {
      let lowC = article.adx_keywords.toLowerCase();
      return lowC.includes(param.search);
    });
    // return demo.filter((article) => {
    //   let lowC = article.adx_keywords.toLowerCase();
    //   return lowC.includes(param.search);
    // });
  }
...
const getNYT = async (period: string, type: string) => {
  let url = `${baseUrl}/${type}/${period}.json`;
  console.log(url);
  try {
